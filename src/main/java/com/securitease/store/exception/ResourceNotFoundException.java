 ...
 * <p>
 * This runtime exception is typically used in service layers when attempting to
 * retrieve entities by their identifiers or other unique attributes. It provides
 * structured error messages to help identify what resource was not found and
...
public class ResourceNotFoundException extends RuntimeException {
     ...
     * <p>
     * Creates a standardized error message in the format:
