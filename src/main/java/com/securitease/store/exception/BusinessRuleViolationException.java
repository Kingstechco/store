 ...
 *
 * <p>This exception is used for scenarios where the request is technically valid but violates business logic rules. It
 * includes an error code to help clients categorize and handle different business rule violations appropriately.
 *
