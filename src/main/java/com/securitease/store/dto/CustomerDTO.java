 ...
 * <p>
 * This DTO is used to transfer customer data between different layers of the application,
 * particularly between the service layer and the presentation layer. It includes
 * customer information along with associated orders to provide a complete view
 * of the customer's data.
 * </p>
 * <p>
 * The orders list contains simplified order information ({@link CustomerOrderDTO})
 ...
 * @see com.example.store.entity.Customer
 */
@Data
