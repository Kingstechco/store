 ...
 * <p>
 * This DTO is used when including order information as part of a customer response
 * to avoid circular references and reduce data transfer overhead. It contains only
 * the essential order information needed for customer-related operations.
 * </p>
 *
